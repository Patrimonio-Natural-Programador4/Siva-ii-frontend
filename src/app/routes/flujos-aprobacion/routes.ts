...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'roles/crear',
        loadComponent: () => import('./roles/acciones/acciones-roles').then(m => m.AccionesRolesAprobacion),
        data: {
      ...
      {
        path: 'delegacion',
        loadComponent: () => import('./delegacion/delegacion-listar').then(m => m.ListarDelegacionesAprobacion),
        data: {
      ...
      },
      {
        ...
        loadComponent: () => import('./delegacion/acciones/delegacion-acciones').then(m => m.AccionesDelegacionAprobacion),
        data: {
